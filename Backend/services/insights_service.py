...
def generate_insights(eda_summary: dict, chart_data: dict = None) -> str:
    """
    Generate AI Insights based on the dataset summary using Groq LLM.
    """
    ...
    try:
        ...
        # Prepare a concise prompt from the EDA summary
        ...
        - Probable Target Variable: {summary.get('target_variable') or 'None identified'}
        ...
        Do NOT write like an AutoML tutorial bot. Write like a senior data analyst reporting to a stakeholder.
